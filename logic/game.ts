...
const cnt4 = traverseRec(board, 0, 0, 'R1',0);
console.log(cnt4);

console.log(nextBoard(board, 'Y3'));
/* 
interface HashTable<T> {
    [key: string]: T;
}

interface coloursCountMap {
    [colour: string]: number;
}
let colourCount:coloursCountMap;
colourCount['R1']=1111;
console.log(colourCount['R1']) */

class ColourCountMap {
    [index: string]: number;


}

let f = new ColourCountMap();
